      ...
      <div className="bg-zinc-800/90 backdrop-blur-sm border border-zinc-700 max-w-md w-full p-4 px-6 rounded-xl shadow-xl space-y-6">
        ...
        <form className="space-y-2" onSubmit={handleSubmit}>
          ...
          <label className="flex items-center text-sm text-zinc-300 my-3">
            <input type="checkbox" className="mr-2 accent-zinc-500" required />I
            agree to{" "}
            <a
              href="#"
          ...
          <button className="w-full flex items-center justify-center gap-2 py-3 bg-gradient-to-r from-zinc-600 to-zinc-700 hover:from-zinc-700 hover:to-zinc-800 text-white rounded-lg shadow-md">
